...
$sql_donor_info = "SELECT name, email, phone FROM donors WHERE id = ?";
$stmt = $conn->prepare($sql_donor_info);
$stmt->bind_param("i", $_SESSION['donor_id']);
$stmt->execute();
$result_donor_info = $stmt->get_result();
$donor_info = $result_donor_info->fetch_assoc();
...
<body>
    ...
    <div class="container mt-5">
        <h2>Welcome, <?php echo htmlspecialchars($donor_info['name']); ?>!</h2>
        <p>Email: <?php echo htmlspecialchars($donor_info['email']); ?></p>
        <p>Phone: <?php echo htmlspecialchars($donor_info['phone']); ?></p>
    </div>
    ...
    <div id="account" class="container mt-5">
        ...
        <h4 class="mt-5">Edit Contact Information</h4>
        <form action="edit_contact_info.php" method="POST">
            <div class="form-group">
                <label for="email">Email</label>
                <input type="email" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($donor_info['email']); ?>" required>
            </div>
            <div class="form-group">
                <label for="phone">Phone</label>
                <input type="text" class="form-control" id="phone" name="phone" value="<?php echo htmlspecialchars($donor_info['phone']); ?>" required>
            </div>
