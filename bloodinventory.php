...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Determine the status based on the expiration date
    $current_date = date("Y-m-d H:i:s");
    $status = (strtotime($expiration_date) < strtotime($current_date)) ? "Expired" : "Available";
    "Taken";

    // Insert the data into the blood_inventory table
    $sql = "INSERT INTO blood_inventory (blood_type, quantity_units, expiration_date, last_updated, status) 
            VALUES ('$blood_type', '$quantity_units', '$expiration_date', '$last_updated', '$status')";
        ...
        <form action="#" method="POST" class="mb-5">
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    <input type="number" class="form-control" id="quantity_units" name="quantity_units" required step="0.5" min="0.5" oninput="checkValue(this)">
                </div>
                <div class="col">
